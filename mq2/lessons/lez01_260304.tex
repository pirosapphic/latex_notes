...
\noindent\fbox{%
	...
	\textbf{Dimostrazione:} Preso $b\in E$, si consideri $(b,a_n) - (b,l) = (b, a_n - l) $:	per la disuguaglianza di Schwarz, $ || (b,a_n-l) ||^2 \leq(b,b)(a_n-l,a_n-l)$,
...
$$ \forall \varepsilon>0\;\exists n_0\in\mathbb{N} \text{ t.c } \forall n,m>n_0,\:
d(\ket{a}_n - \ket{a}_m)<\varepsilon$$
...
$$ S := \left\{ f(x) \in C^{\infty} / \lim\limits_{|x|\to\infty}
...
esaustiva si vedano le dispense del prof. Sciuto, pp. 156-157.} in
$ \mathcal{D}_A = \left\{ f:(a,b)\to\mathbb{C} \text{ periodiche} \right\}$, per $ (a,b)$ finito.

Il concetto di osservabile si può estendere anche alle distribuzioni temperate\footnote{
    Anche se esse non rappresentano propriamente stati fisici, come si vedrà
in seguito}:
