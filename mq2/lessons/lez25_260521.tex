...
\end{gather*}
Calcolando similmente $\langle A'B'\rangle$, $\langle AB'\rangle$ e $\langle A'B\rangle$ si trova
$$\langle M\rangle=-\cos(\vartheta_a-\vartheta_b)+\cos(\vartheta_a-\vartheta_b')
-\cos(\vartheta_a'-\vartheta_b)-\cos(\vartheta_a'-\vartheta_b')$$
Se si considera il caso in cui le direzioni $\vartheta_i$ e $\vartheta_i'$ sono ortogonali e in cui
$\vartheta=\vartheta_a'-\vartheta_b=\frac{\pi}{4}$, si ha che
$$\langle M\rangle=4\frac{\sqrt{2}}{2}=2\sqrt{2}\mathbf{>2}$$
che \textbf{viola la disuguaglianza di Bell}.
%qui manca un ultimissimo esempio, che però a parer mio non ha senso mettere in quanto è estremamente
