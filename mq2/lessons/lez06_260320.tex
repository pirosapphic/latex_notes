...
$\vartheta=\atan\left(\frac{a_2}{a_1}\right)$; se invece $\frac{a_2}{a_1} = \pm i$, la polarizzazione è
circolare.
...
\end{pmatrix}
$$
Come prima, la polarizzazione è lineare di angolo $\vartheta=\atan\left(a_2/a_1\right)$ se
...
$$\vartheta = \pi/4 \rightarrow\rho_{\pi/4} = \frac{1}{2}
\begin{pmatrix}
    1&1\\
    1&1
\end{pmatrix}
...
\frac{1}{2}$$
Ma se invece si calcola la probabilità di trovare la luce polarizatta a $\vartheta=\frac{\pi}{4}$ si trova
$$\mathcal{P}_\psi(\vartheta=\pi/4) = \Tr\left(\ket{\psi}\bra{\psi}\ket{\frac{\pi}{4}}\bra{\frac{\pi}{4}}\right) = 1
\quad\text{(poiché $\ket{\psi}=\ket{\frac{\pi}{4}}$)}
$$
$$\mathcal{P}_\rho(\vartheta=\pi/4) = \Tr(\rho P_{\frac{\pi}{4}}) = \frac{1}{2}\Tr(P_{\frac{\pi}{4}}) =
\frac{1}{2}$$
questo vale $\forall \vartheta$, in quanto la traccia di un proiettore è sempre 1.
