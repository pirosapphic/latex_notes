...
$$K=\int \prod_{i=1}^{N-1} d^dq_i \prod_{j=0}^{N-1}\bra{q_{j+1}}U(t_{j+1},t_j)\ket{q_j}$$
...
$$
e la parte dipendente dai $p_i$ di (\ref{eq:K_discr_tot}) diventa
$$
...
$$K(x,\varepsilon,y,0) = \sqrt{\frac{m}{2\pi i\hbar\varepsilon}}\exp\left\{\frac{i}{\hbar}\left(\frac{1}{2}m\dot
y^2-V(y)\right)\varepsilon\right\}$$
per $\varepsilon\to0$, $V(y)\sim V(x)$ e $\dot y\sim \frac{x-y}{\varepsilon}$, dunque si ha
$$K = \sqrt{\frac{m}{2\pi i\hbar\varepsilon}}\exp\left\{\frac{i}{\hbar}\left(\frac{1}{2}m\frac{(x-y)^2}
{\varepsilon}-V(x)\varepsilon\right)\right\}$$
Dunque, applicando (\ref{eq:K_def})
$$\psi(x,\varepsilon) = \sqrt{\frac{m}{2\pi\hbar i\varepsilon}}e^{-\frac{i}{\hbar}V(x)\varepsilon}
...
$$i\hbar\pdv[]{}{t}\psi(x,0)=\frac{-\hbar^2}{2m}\dv[2]{}{x}\psi(x,0)+V(x)\psi(x,0)$$
