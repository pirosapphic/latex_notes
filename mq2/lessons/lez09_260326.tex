...
Si consideri il propagatore tra due istanti di tempo distanti $\epsilon\to0$ tra loro: poiché non è
necessario suddividere l'intervallo in parti infinitesime, esso vale
$$K(x,\epsilon,y,0) = \sqrt{\frac{m}{2\pi\hbar\epsilon}}\exp\left\{\frac{i}{\hbar}\left(\frac{1}{2}m\dot
y^2-V(y)\right)\right\}$$
per $\epsilon\to0$, $V(y)\sim V(x)$ e $\dot y\sim \frac{x-y}{\epsilon}$, dunque si ha
$$K = \sqrt{\frac{m}{2\pi\hbar\epsilon}}\exp\left\{\frac{i}{\hbar}\left(\frac{1}{2}m\frac{(x-y)^2}
{\epsilon}-V(x)\epsilon\right)\right\}$$
Dunque, applicando (\ref{eq:K_def})
$$\psi(x,\epsilon) = \sqrt{\frac{m}{2\pi\hbar\epsilon}}e^{-\frac{i}{\hbar}V(x)\epsilon}
\int_{-\infty}^{\infty}dy \exp\left\{\frac{im}{2\hbar}\frac{(x-y)^2}{\epsilon}\right\}\psi(y,0)
$$
ponendo $z=\sqrt{\frac{m}{\hbar}}(x-y)\to dz=-\sqrt{\frac{m}{\hbar}}dy$ e poi $\alpha = i\epsilon$
(rotazione di Wick), si ottiene
\begin{gather*}
\psi(x,\epsilon) = \sqrt{\frac{1}{2\pi i\epsilon}}e^{-\frac{i}{\hbar}V(x)\epsilon}
\int_{-\infty}^{\infty}dz e^{\frac{i}{2\epsilon}z^2}\psi\left(x-\sqrt{\frac{\hbar}{m}}z,0\right)=\\
...
\end{gather*}
si noti che l'espansione in potenze di $z$ è dovuta al fatto che $z\to0$ se $\epsilon\to0$.

Integrando esplicitamente e riscrivendo in termini di $\epsilon$ si ottiene
$$\psi(x,\epsilon) = e^{-\frac{i}{\hbar}V(x)\epsilon}\left(\psi(x,0)+\frac{i\epsilon\hbar}{2m}
\psi''(x,0)\right)$$
Sviluppando sia il lato sinistro sia l'esponenziale a destra in potenze di $\epsilon$ si trova
\begin{gather*}
\psi(x,0)+\epsilon\eval{\pdv[]{\psi}{t}}_{t=0} = \left(1-\frac{i\epsilon}{\hbar}V(x)+O(\epsilon^2)
\right)\left(\psi(x,0)+\frac{i\epsilon\hbar}{2m}\psi''(x,0)+O(\epsilon^2)\right)\\
\psi(x,0)+\epsilon\eval{\pdv[]{\psi}{t}}_{t=0}=\psi(x,0)-\frac{i}{\hbar}\epsilon
\left(V(x)\psi(x,0)-\frac{\hbar^2}{2m}\psi''(x,0)\right)+O(\epsilon^2)
\end{gather*}
eguagliando i termini di prim'ordine in $\epsilon$ si ottiene infine
