...
\end{gather*}
dove si è utilizzato il fatto che $\bra{p_j}\hat H\ket{q_j}=H(q_j,p_j)\bra{p_j}\ket{q_j}$, si è ritornati
...
\end{gather*}
eguagliando i termini di prim'ordine in $\varepsilon$ si ottiene infine
