...
\begin{gather*}
[H,F]=0\leftrightarrow[U,F]=\sum_{n=0}^{\infty}\left(-\frac{i}{\hbar}(t-t_0)\right)^n\frac{1}{n!}[H^n,F]=\\
=\sum_{n=0}^{\infty}\left(-\frac{i}{\hbar}(t-t_0)\right)^n\frac{1}{n!}
\left(\sum_{k=1}^{n}H^{k-1}[H,F]H^{n-k}\right)=0
\end{gather*}
