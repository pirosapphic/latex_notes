...
\begin{itemize}
    ...
    \item $\left|\mathbf{p}\right|^2$ piccolo, cioè \textbf{impulso piccolo}.
\end{itemize}
...
che significa \textbf{potenziale lentamente variabile} e \textbf{impulso piccolo}.
...
\textit{Oss.} In tutti gli ordini, si trova un'equazione differenziale lineare rispetto alla funzione
...
\textit{Oss.} La densità di proabilità associata a $\psi(x,t)$ è proporzionale a quella classica:
